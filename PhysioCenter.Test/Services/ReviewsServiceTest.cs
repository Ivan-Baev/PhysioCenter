    ...
    public class ReviewsServiceTest
    {
        ...
        public async Task Setup()
        {
            ...
            serviceProvider = serviceCollection
                ...
                .AddSingleton<IReviewsService, ReviewsService>()
        ...
        {
            var service = serviceProvider.GetService<IReviewsService>();
        ...
        public void GetByIdAsyncMustThrowErrorInvalidId()
        {
            ...
            Assert.That(async () => await service.GetByIdAsync(id),
                Throws.TypeOf<ArgumentException>().With.Message.EqualTo("This review does not exist!"));
        }
